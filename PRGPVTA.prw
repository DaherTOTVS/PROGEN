...
cQryDetail:= "SELECT C6_ITEM, C6_NUM, C6_PRODUTO, ISNULL(CAST(CAST(C6_VDOBS AS VARBINARY(8000)) AS VARCHAR(8000)),'') AS OBS , C6_DESCRI, C6_PRCVEN, C6_QTDVEN, C6_VALOR, C6_LOJA, C6_CLI, C6_LOCAL, C6_UM, " 
...
cQryDetail+= "WHERE A.C6_NUM = '"+cPedido+"' AND A.C6_LOJA='"+cTienda+"'  AND A.C6_CLI =  '"+cCliente+"'  AND A.D_E_L_E_T_ <>'*' ORDER BY 1 " + CRLF
